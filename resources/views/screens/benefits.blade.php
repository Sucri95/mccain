        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">Cargá un nuevo Beneficio</div>
                    <div class="panel-body">
                        <form method="POST" action="/create/benefits" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            <input class="form-input" type="text" name="title" placeholder="Título del beneficio">
                            <textarea class="description" name="about" placeholder="Descripción del beneficio"></textarea>
                            ...
                            <input class="form-input" type="text" name="location" placeholder="Ubicación (Zona)">
