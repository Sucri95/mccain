        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">Cargá una Novedad</div>
                    <div class="panel-body">
                        <form method="POST" action="/create/news" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            <input class="form-input" type="text" name="title" placeholder="Título de la Novedad" style="width: 100%;">
                            
                            <textarea class="description" name="about" placeholder="Descripción de la Novedad"></textarea>
